  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        I build production-ready Generative AI systems spanning agentic
        reasoning, retrieval-augmented generation, and full-stack deployment.
      </h2>
    </div>
  );
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn("GENERATIVE AI & LLMS", SKILLS.genAI)}
          </div>
          <div className="flex flex-wrap mt-10">
            <div className="mr-6 mb-6">
              {renderSkillColumn("ML & DEEP LEARNING", SKILLS.mlDl)}
            </div>
            <div>
              {renderSkillColumn("BACKEND, LANGUAGES & TOOLS", SKILLS.toolsBackend)}
            </div>
          </div>
        </div>
      </div>
