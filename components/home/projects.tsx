...
const PROJECT_STYLES = {
  SECTION:
    "w-full relative select-none section-container flex-col flex pt-28 pb-8 justify-center",
  PROJECTS_WRAPPER:
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
        A selection of AI/ML projects spanning agentic systems, RAG
        pipelines, and production backend engineering
      </h2>
    </div>
  );
