...
const HERO_STYLES = {
  ...
  BG_WRAPPER:
    "absolute hero-bg right-0 md:bottom-0 bottom-0 -z-1 md:w-3/4 w-full scale-90 sm:scale-100 flex items-end pointer-events-none",
  ...
  const renderHeroContent = (): React.ReactNode => (
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        ...
        <h1 className="text-3xl seq">I am Abbas Rahman</h1>
      </div>
      <p className="mb-4">
