...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am an AI/ML engineer who builds production-ready Generative AI
      ...
      >
        I take responsibility to ship reliable, retrieval-augmented systems
        that reason, retrieve, and respond.
      </span>
    </h1>
  );
